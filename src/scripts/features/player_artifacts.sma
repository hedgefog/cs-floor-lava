...
public plugin_init() {
  register_plugin(PLUGIN_NAME("Player Artifacts"), FLOORLAVA_VERSION, "Hedgehog Fog");
}
...
public plugin_natives() {
  register_library(LIBRARY(Artifacts));
  register_native("FloorLava_PlayerArtifact_Register", "Native_RegisterArtifact");
  register_native("FloorLava_PlayerArtifact_IsRegistered", "Native_IsRegistered");
  register_native("FloorLava_PlayerArtifact_GetHandle", "Native_GetHandle");
  register_native("FloorLava_PlayerArtifact_Give", "Native_GiveArtifact");
  register_native("FloorLava_PlayerArtifact_Take", "Native_TakeArtifact");
  register_native("FloorLava_PlayerArtifact_TakeAll", "Native_TakeAllArtifacts");
  register_native("FloorLava_PlayerArtifact_TakeBySlot", "Native_TakeArtifactBySlot");
  register_native("FloorLava_PlayerArtifact_Has", "Native_HasArtifact");
  register_native("FloorLava_PlayerArtifact_Find", "Native_FindArtifact");
}
